...
const subscriptiontwelvemonth = () =>{
  const [loading, setLoading] = useState(false);

    return(
        <>
        <Helmet>
          <title>ANNUAL SUBSCRIPTION FORM - Masterclass in Orthodontics</title>
        </Helmet>
    <Navbar/>
    <div className="min-h-screen py-32 flex flex-col items-center"
        ...
        >
          ...
          <h2 className="text-4xl font-semibold text-gray-500 mt-2 text-center">
          ...
          onSubmit={async (e) => {
            ...
            try {
              ...
              const res = await fetch(
                "https://powderblue-wasp-496475.hostingersite.com/php_php/subscription_twelve.php",
                {
                  method: "POST",
                  headers: {
              ...
              if (data.status === "success") {
                window.location.href = `https://powderblue-wasp-496475.hostingersite.com/php_php/subscription_twelve.php?id=${data.id}`;
              } else {
...
export default subscriptiontwelvemonth;