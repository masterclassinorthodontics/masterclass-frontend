          ...
          onSubmit={async (e) => {
            ...
            try {
              ...
              const res = await fetch(
                "https://masterclassinorthodontics.com/php_php/subscription_six.php",
                {
                  method: "POST",
                  headers: {
              ...
              if (data.status === "success") {
                window.location.href = `https://masterclassinorthodontics.com/php_php/subscription_six.php?id=${data.id}`;
              } else {
