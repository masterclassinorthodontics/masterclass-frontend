...
const subscriptionsixmonth = () =>{
  const [loading, setLoading] = useState(false);

    return(
        <>
        <Helmet>
          <title>HALF-YEARLY SUBSCRIPTION FORM - Masterclass in Orthodontics</title>
        </Helmet>
    <Navbar/>
          ...
          onSubmit={async (e) => {
            ...
            try {
              ...
              const res = await fetch(
                "https://powderblue-wasp-496475.hostingersite.com/php_php/subscription_six.php",
                {
                  method: "POST",
                  headers: {
              ...
              if (data.status === "success") {
                window.location.href = `https://powderblue-wasp-496475.hostingersite.com/php_php/subscription_six.php?id=${data.id}`;
              } else {
...
export default subscriptionsixmonth;