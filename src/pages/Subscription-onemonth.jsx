...
const subscriptiononemonth = () => {
  const [loading, setLoading] = useState(false);

  return (
    <>
      <Helmet>
        <title>MONTHLY SUBSCRIPTION FORM - Masterclass in Orthodontics</title>
      </Helmet>
      <Navbar />
      ...
      >
        ...
        >
          ...
          <div className="space-y-1">
            <label className="flex items-start gap-2">
              ...
              <span>
                ...
                regulation of Dental Council of India
              </span>
            </label>
          </div>
          ...
          {/* Submit */}
          <button type="submit" className="pt-6" disabled={loading}>
            <img
              src={submitBtn}
              alt="Submit"
...
export default subscriptiononemonth;